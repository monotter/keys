...
local KeySec = KeyTab:NewSection("Control Keybinds")
...
KeySec:NewKeybind("Enable JJ", "Enables JJ with Keybind", Enum.KeyCode.K, function()
    ToggleJJ:UpdateToggle("Enable", not JJEnabled)
end)
KeySec:NewKeybind("Enable GJ", "Enables GJ with Keybind", Enum.KeyCode.L, function()
    ToggleGJ:UpdateToggle("Enable", not GJEnabled)
end)